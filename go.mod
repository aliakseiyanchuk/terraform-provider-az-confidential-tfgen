module github.com/aliakseiyanchuk/terraform-provider-az-confidential-tfgen

go 1.24.2

require github.com/aliakseiyanchuk/terraform-provider-az-confidential v0.10.0-a
